...
export class DialogHolderComponent {
   ...
   */
  addDialog(component:Type<DialogComponent>, modalCfg?:any, data?:any, index?:number):Observable<any> {
    ...
    dialogWrapper.setModalCfg(modalCfg);
    ...
    return _component.fillData(data, modalCfg);
  }
